...
var productServise_2 = require("./productServise");
var ProductControler = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, productServise_2.default.getAll()];
                    case 1:
                        product = _a.sent();
                        res.json(product);
                        return [3 /*break*/, 3];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        id = +req.params.id;
                        return [4 /*yield*/, productServise_2.default.getOne(id)];
                    case 1:
                        OneProduct = _a.sent();
                        if (!OneProduct) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, productServise_2.default.saveAll(req.body)];
                    case 1:
                        prodoct = _a.sent();
    ...
    ;
    ProductControler.prototype.put = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, product, update, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        product = req.body;
                        product.id = id;
                        return [4 /*yield*/, productServise_1.default.put(product)];
                    case 1:
                        update = _a.sent();
                        res.json(update);
                        return [3 /*break*/, 3];
    ...
    ;
    ProductControler.prototype.patch = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, product, update, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        product = req.body;
                        product.id = id;
                        return [4 /*yield*/, productServise_1.default.patch(product)];
                    case 1:
                        update = _a.sent();
                        res.json(update);
                        res.json('update');
...
exports.ProductControler = ProductControler;
;
