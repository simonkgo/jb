...
var EmployeesRepository = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.readFile('./database/employee.json', 'utf-8')];
                    case 1:
                        allEmployees = _a.sent();
                        return [2 /*return*/, JSON.parse(allEmployees)];
                    case 2:
                        err_1 = _a.sent();
                        throw err_1;
    ...
    EmployeesRepository.prototype.save = function (employees) {
        return __awaiter(this, void 0, void 0, function () {
            var err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.writeFile('./database/employee.json', JSON.stringify(employees))];
