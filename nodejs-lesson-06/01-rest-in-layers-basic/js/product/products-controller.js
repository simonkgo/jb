...
var ProductsController = /** @class */ (function () {
    ...
    ;
    ProductsController.prototype.activateRoutes = function () {
    ...
    ProductsController.prototype.all = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                try {
                    products = products_service_1.default.all();
                    res.json(products);
                }
                catch (err) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        err_1 = _a.sent();
                        res.status(404).send(err_1.message);
                        return [3 /*break*/, 3];
                    case 3:
                        ;
                        return [2 /*return*/];
    ...
    ProductsController.prototype.post = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name_1, price, stock, product, errors, result, err_2;
    ...
    ProductsController.prototype.put = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var idParams, product, result, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                    ...
                    case 2:
                        err_3 = _a.sent();
                        res.status(404).send(err_3.message);
                        return [3 /*break*/, 3];
                    case 3:
                        ;
                        return [2 /*return*/];
    ...
    ProductsController.prototype.patch = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var idParams, product, result, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    ProductsController.prototype.auth = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    next(new error_middleware_1.Forbidden("you are going on a forbidden road"));
                }
                catch (err) {
                    next(err);
                }
    ...
    ;
    ProductsController.prototype.badReq = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                try {
                    next(new error_middleware_1.BadReq("you are making a bad request"));
                }
                catch (err) {
                    next(err);
                }
