...
var EmployeesService = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        employee = result.find(function (emp) { return emp.id === id; });
                        return [2 /*return*/, employee];
                }
            });
        });
    };
    EmployeesService.prototype.postOne = function (employee) {
        return __awaiter(this, void 0, void 0, function () {
            var employees;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    EmployeesService.prototype.updateOne = function (employee) {
        return __awaiter(this, void 0, void 0, function () {
            var employees, index;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        employees = _a.sent();
                        index = employees.findIndex(function (emp) { return emp.id === employee.id; });
    ...
    EmployeesService.prototype.partlyUpdate = function (employee) {
        return __awaiter(this, void 0, void 0, function () {
            var employees, currentEmployee, key;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, employees_repository_1.default.getAll()];
                    case 1:
    ...
    EmployeesService.prototype.deleteOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var employees, index;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        employees = _a.sent();
                        index = employees.findIndex(function (emp) { return emp.id === id; });
