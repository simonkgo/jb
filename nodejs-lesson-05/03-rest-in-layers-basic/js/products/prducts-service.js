...
var producs_repository_1 = require("./producs-repository");
    ...
    ProductsService.prototype.all = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, producs_repository_1.default.getAll()];
                    case 1:
                        products = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, producs_repository_1.default.saveAll(products)];
                    case 2:
                        //שמירת המערך בחזרה לקובץ אחרי ההוספה של המוצר החדש;
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        products = _a.sent();
                        index = products.findIndex(function (prod) { return prod.id === product.id; });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        products = _a.sent();
                        result = products.find(function (p) { return p.id === product.id; });
                        for (key in product) {
                            if (key in result) {
